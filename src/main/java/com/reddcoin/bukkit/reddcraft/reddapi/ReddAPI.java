package com.reddcoin.bukkit.reddcraft.reddapi;
 ...
 * Slightly modified to maintain a singleton
 * 
 ...
 * 
 */
public class ReddAPI {

	private static ReddAPI instance = null;
	...
	public static ReddAPI getInstance() {
	      if(instance == null) {
	         instance = new ReddAPI();
	      }
	      return instance;
	   }
